...
const Filter = props => {
  ...
  return /*#__PURE__*/React.createElement(FormGroup, {
    variant: "filter"
  }, /*#__PURE__*/React.createElement(Label, null, property.label), /*#__PURE__*/React.createElement(Label, null, `- ${translateProperty('from')}: `), /*#__PURE__*/React.createElement(DatePicker, {
    value: fromValue,
