...
const Login = props => {
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(GlobalStyle, null), /*#__PURE__*/_react.default.createElement(Wrapper, {
    ...
    fontWeight: "lighter",
    mt: "default"
  }, translateMessage('loginWelcome'))), /*#__PURE__*/_react.default.createElement(_designSystem.Box, {
    as: "form",
    action: action,
    method: "POST",
    p: "x3",
    ...
    variant: "danger"
  }), /*#__PURE__*/_react.default.createElement(_designSystem.Label, null, "Please Login Via Partner Portal"))), branding.withMadeWithLove ? /*#__PURE__*/_react.default.createElement(_designSystem.Box, {
    mt: "xxl"
